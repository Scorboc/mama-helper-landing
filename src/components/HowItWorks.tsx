...
const steps = [
  ...
  },
  {
    ...
    text: 'Срок беременности или дата рождения ребёнка до 6 лет включительно. Возраст обновляется автоматически; можно выбрать темы, включая детский сад и школу.',
    bg: 'bg-cream',
  },
  {
    n: '03',
