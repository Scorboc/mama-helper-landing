...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "glass-pill inline-flex h-10 items-center justify-center p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
